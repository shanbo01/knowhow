...
| Raw or sensitive screenshot persistence | Visible-tab only, no form-value/raw-key/clipboard capture, password/iframe masking, opt-in detectors, local raster/redaction, attestation, magic/dimension/size validation, privacy review | Canvas/video/native UI and human review gaps; prohibited-data policy remains essential |
